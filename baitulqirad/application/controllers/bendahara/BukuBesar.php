...
class BukuBesar extends CI_Controller{
		...
		public function tampilBukber()
	{
		...
		$data['tampilkan'] = $this->db->query("SELECT jurnalbq.tgl, jurnalbq.no_reff, jurnalbq.akun, 
			                                            jurnalbq.keterangan, jurnalbq.debet, jurnalbq.kredit
													FROM jurnalbq
													WHERE  jurnalbq.akun='$akun'")->result();
