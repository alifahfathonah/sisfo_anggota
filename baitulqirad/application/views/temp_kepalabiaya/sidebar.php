<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <!-- Nav Item - Dashboard -->
      <li class="nav-item">
        <a class="nav-link" href="<?php echo base_url('kepalabiaya/dashboard') ?>">
      ...
      <li class="nav-item">
        <a class="nav-link" href="<?php echo base_url('kepalabiaya/profil') ?>">
      ...
      <!-- Nav Item - Pages Collapse Menu -->
      <li class="nav-item">
        <a class="nav-link" href="<?php echo base_url('kepalabiaya/agendaUmum') ?>">
      ...
      <!-- Nav Item - Logout -->
      <li class="nav-item">
        <a class="nav-link" href="<?php echo base_url('kepalabiaya/ubahPassword') ?>">
