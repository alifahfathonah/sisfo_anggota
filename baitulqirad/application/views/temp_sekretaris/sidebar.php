<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <!-- Nav Item - Dashboard -->
      <li class="nav-item">
        <a class="nav-link" href="<?php echo base_url('sekretaris/dashboard') ?>">
      ...
      <li class="nav-item">
        <a class="nav-link" href="<?php echo base_url('sekretaris/profil') ?>">
          <i class="far fa-id-card"></i>
          <span>Profil Sekretaris</span></a>
      </li>


      <!-- Nav Item - Pages Collapse Menu -->
      <li class="nav-item">
        <a class="nav-link" href="<?php echo base_url('sekretaris/agendaUmum') ?>">
      ...
      <li class="nav-item">
        <a class="nav-link" href="<?php echo base_url('sekretaris/agendaKhusus') ?>">
      ...
      <!-- Nav Item - Logout -->
      <li class="nav-item">
        <a class="nav-link" href="<?php echo base_url('sekretaris/ubahpassword') ?>">
