        ...
        <div class="container-fluid">
            ...
            <div class="row ml-1">
                ...
                <div class="card ml-1" style="width:31%; height: 150px;">
                    <div class="card-body">
                        <?php echo form_open_multipart('DewanCendekiawan_Anggota/update_aksi_fotoAnggota'); ?>
                        ...
                        <div class="card-footer" style="width: 100%;">
                            ...
                            <a class="btn btn-danger"
                                href="<?php echo base_url('DewanCendekiawan_Anggota/profile_anggota') ?>">Kembali</a>
                        </div>
                    </div>
                </div>
