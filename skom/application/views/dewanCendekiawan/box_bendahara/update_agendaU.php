    ...
    <section class="content ">
        ...
        <div class="card" style="width:80%;">
            <div class="card-body">
                ...
                <form method="POST" action="<?php echo base_url() . 'AgendaUmum_DC/updateAgendaU_aksi_Abendahara'; ?>">
                    ...
                    <a class="btn btn-danger" href="<?php echo base_url('AgendaUmum_DC/all_Abendahara') ?>">Kembali</a>
                </form>
                <?php endforeach; ?>
            </div>
        </div>
