      ...
      <div class="sidebar">
          ...
          <nav class="mt-2">
              <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                  ...
                  <li class="nav-item">
                      <a href="<?= base_url('DewanCendekiawan_Sekretaris'); ?>" class="nav-link">
                  ...
                  <li class="nav-item">
                      <a href="<?= base_url('DewanCendekiawan_Sekretaris'); ?>/profile_sekretaris" class="nav-link">
                          <i class="fas fa-user nav-icon"></i>
                          <p>Profil</p>
                      </a>
                  </li>
                  <li class="nav-item">
                      <a href="<?= base_url('AgendaUmum_DC'); ?>/all_Asekretaris" class="nav-link">
                  ...
                  <li class="nav-item">
                      <a href="<?= base_url('DewanCendekiawan_Sekretaris/change_passwordSekretaris'); ?>"
                          class="nav-link">
                  ...
                  <li class="nav-item">
                      <a href="<?= base_url('user_komunitas/sekretaris_d_c'); ?>" class="nav-link">
