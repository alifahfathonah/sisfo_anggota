      ...
      <div class="sidebar">
          ...
          <nav class="mt-2">
              <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                  ...
                  <li class="nav-item">
                      <a href="<?= base_url('DewanCendekiawan_Bendahara'); ?>" class="nav-link">
                  ...
                  <li class="nav-item">
                      <a href="<?= base_url('DewanCendekiawan_Bendahara'); ?>/profile_bendahara" class="nav-link">
                          <i class="fas fa-user nav-icon"></i>
                          <p>Profil</p>
                      </a>
                  </li>
                  <li class="nav-item">
                      <a href="<?= base_url('AgendaUmum_DC'); ?>/all_Abendahara" class="nav-link">
                  ...
                  <li class="nav-item">
                      <a href="<?= base_url('DewanCendekiawan_Bendahara/change_passwordBendahara'); ?>"
                          class="nav-link">
                  ...
                  <li class="nav-item">
                      <a href="<?= base_url('user_komunitas/bendahara_d_c'); ?>" class="nav-link">
