...
<div class="content-wrapper">
    <div class="content-header ml-1" style="margin-bottom: -15px;">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h4 class="text-lightgray text-bold">Update Agenda</h4>
            </div>
        </div>
    </div>
    ...
    <section class="content ">
        ...
        <div class="card" style="width:80%;">
            <div class="card-body">
                ...
                <form method="POST" action="<?php echo base_url() . 'AgendaUmum_DC/updateAgendaU_aksi_Asekretaris'; ?>">
                    ...
                    <a class="btn btn-danger" href="<?php echo base_url('AgendaUmum_DC/all_Asekretaris') ?>">Kembali</a>
                </form>
                <?php endforeach; ?>
            </div>
        </div>
