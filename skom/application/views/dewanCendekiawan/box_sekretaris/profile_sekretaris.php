                            ...
                            <table class="table table-sm">
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="table-dark">
                                            <a href="<?= base_url('DewanCendekiawan_Sekretaris'); ?>/edit_profileSekretaris"
                                                class="nav-link p-1">
                                    ...
                                    <tr>
                                        ...
                                        <td class="table-dark">
                                            <a href="<?= base_url('DewanCendekiawan_Sekretaris'); ?>/edit_fotoSekretaris"
                                                class="nav-link p-1">
                                                <button class="btn btn-warning float-right">
                                                    <i class="nav-icon far fa-edit"></i>
                                                    </li>
