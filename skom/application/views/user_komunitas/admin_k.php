    ...
    <header id="header" class="fixed-top">
        <div class="container-fluid d-flex ">
            ...
            <div class="logo mr-auto">
                <h1 class="text-light"><a href=""><span><?php echo $title ?></span></a>
                </h1>
            ...
            <nav class="nav-menu d-none d-lg-block">
                <ul>
                    ...
                    <li class="drop-down"><a href="#">Informasi</a>
                        <ul>
                            <li><a href="<?= base_url("user_informasi/informasi_kom"); ?>">Informasi Komunitas
                                    Koperasi</a></li>
                    ...
                    <li class="get-started"><a href="<?= base_url("Auth/indexAdmin"); ?>">Logout</a></li>
                </ul>
            </nav><!-- .nav-menu -->
