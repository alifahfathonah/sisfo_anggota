    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row" style="margin-bottom: -15px; margin-top: -9px;">
                <div class="col-sm-6">
                    <h4 class="text-lightgray text-bold">Update Data Konten Pembiayaan</h4>
                </div>
            </div>
        </div>
    </div>
    ...
    <section class="content ">
        ...
        <div class="card ml-2" style="width:98%;">
            <div class="card bg-success mb-0" style="height: 40px;">
                <p class="float-left" style="margin-top: 7px; margin-left: 22px;">Konten Pembiayaan :
                </p>
            </div>
            <div class="card-body">
            <?php foreach ($konten_pembiayaan as $p) : ?>
                <form method="POST" action="<?php echo base_url('informasi_d_p_StafBKeanggotaan/pembiayaan/update_pembiayaan_aksi'); ?>" enctype="multipart/form-data">
                    ...
                    <div class="card-footer mt-5" style="width: 100%; margin-bottom: -15px;">
                        ...
                        <a class="btn btn-danger ml-1 float-right" href="<?php echo base_url('informasi_d_p_StafBKeanggotaan/pembiayaan') ?>">Kembali</a>
                    </div>
                </form>
                <?php endforeach; ?>
            </div>
