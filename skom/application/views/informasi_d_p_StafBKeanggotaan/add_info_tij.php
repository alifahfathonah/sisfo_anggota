...
<div class="content-wrapper">
    ...
    <section class="content ">
        ...
        <div class="card ml-2" style="width:98%;">
            ...
            <div class="card-body">
                <form method="POST" action="<?php echo base_url('informasi_tij/add_info_aksi'); ?>" enctype="multipart/form-data">
                    ...
                    <div class="row" style="height:auto">
                        ...
                        <div class="col-md-6 mx-auto">
                            ...
                            <div class="form-group" style="margin-top: -10px;">
                                <label class="ml-2">Informasi Koperasi Tijarah</label>
                                <textarea name="desc_tij" class="form-control" required></textarea>
