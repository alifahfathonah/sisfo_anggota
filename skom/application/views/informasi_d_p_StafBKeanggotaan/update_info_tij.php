    ...
    <section class="content ">
        ...
        <div class="card ml-2" style="width:98%;">
            <div class="card bg-success mb-0" style="height: 40px;">
                <p class="float-left" style="margin-top: 7px; margin-left: 22px;">Informasi Koperasi Tijarah :
                </p>
            </div>
            <div class="card-body">
            <?php foreach ($info as $i) : ?>
                <form method="POST" action="<?php echo base_url('informasi_tij/update_info_aksi'); ?>" enctype="multipart/form-data">
                    ...
                    <div class="row" style="height:auto">
                        ...
                        <div class="col-md-6 mx-auto">
                            <div class="form-group" style="margin-top: -10px;">
                                ...
                                <input type="hidden" name="id_info_tij" class="form-control" value="<?= $i->id_info_tij ?>">
                            ...
                            <div class="form-group" style="margin-top: -10px;">
                                <label class="ml-2">Informasi Tentang Koperasi Tijarah</label>
                                <textarea name="desc_tij" class="form-control" value="<?= $i->desc_tij ?>"required></textarea>
                    ...
                    <div class="card-footer mt-5" style="width: 100%; margin-bottom: -15px;">
                        ...
                        <a class="btn btn-danger ml-1 float-right" href="<?php echo base_url('informasi_tij') ?>">Kembali</a>
                    </div>
                </form>
                <?php endforeach; ?>
            </div>
