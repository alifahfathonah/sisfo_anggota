      ...
      <div class="sidebar">
          ...
          <nav class="mt-2">
              <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                  ...
                  <li class="nav-item">
                      <a href="<?= base_url('DewanPimpinan_Ketua'); ?>" class="nav-link">
                  ...
                  <li class="nav-item">
                      <a href="<?= base_url('DewanPimpinan_Ketua'); ?>/profile_ketua" class="nav-link">
                          <i class="fas fa-user nav-icon"></i>
                          <p>Profil Ketua</p>
                      </a>
                  </li>
                  <li class="nav-item">
                      <a href="<?= base_url('AgendaUmum'); ?>/all" class="nav-link">
                          <i class="fas fa-book nav-icon"></i>
                          <p>Daftar Agenda Umum</p>
                      </a>
                  </li>
                  <li class="nav-item">
                      <a href="<?= base_url('DewanPimpinan_Ketua'); ?>/dokumenKetua" class="nav-link">
                  ...
                  <li class="nav-item">
                      <a href="<?= base_url('DewanPimpinan_Ketua/change_password'); ?>" class="nav-link">
                  ...
                  <li class="nav-item">
                      <a href="<?= base_url('user_komunitas/ketua_d_p'); ?>" class="nav-link">
