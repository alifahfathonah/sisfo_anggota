    ...
    <section class="content ">
        ...
        <div class="card" style="width:40%;">
            <div class="card-body">
                ...
                <?php echo form_open_multipart('DewanPimpinan_Sekretaris/updateDokumen_dsekretaris_aksi'); ?>
                ...
                <a class="btn btn-danger"
                    href="<?php echo base_url('DewanPimpinan_Sekretaris/dokumenSekretaris') ?>">Kembali</a>
                </form>
                <?php endforeach; ?>
            </div>
        </div>
