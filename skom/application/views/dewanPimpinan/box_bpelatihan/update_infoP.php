    ...
    <section class="content " style="height: 530px;">
        ...
        <div class="card ml-2" style="width:56%;">
            <div class="card-body">
                ...
                <form method="POST"
                    action="<?php echo base_url() . 'DewanPimpinan_StafBPelatihan/update_Aksi_infoP'; ?>">
                    ...
                    <div class="form-group">
                        ...
                        <input type="hidden" id="id_infoP" name="id_infoP" class="form-control"
                            value="<?php echo $ag->id_infoP ?>">
