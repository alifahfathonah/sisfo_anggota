    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row" style="margin-bottom: -9px;">
                <a class="btn btn-warning ml-2" href="<?= base_url('DewanPimpinan_StafBKeanggotaan/list_anggota') ?>"
                    role="button">
                                                ...
                                                <table class="table table-sm">
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>Admin Anggota Tanpa Jabatan</td>
                                                            <?php } ?>
                                                        </tr>
                                                        <tr>
                                    ...
                                    <div class="col-md-6">
                                            ...
                                            <div class="card-body">
                                                <table class="table table-sm">
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <th class=" col-5 p-2">Kel/Desa</th>
                                                            <td class="p-2">:</td>
                                                            <td class="p-2"><?= $dt->kel_desa ?></td>
                                                        </tr>
                                                        <tr>
                                                            <th class="col-5 p-2">Kecamatan</th>
                                                            <td class="p-2">:</td>
                                                            <td class="p-2"><?= $dt->kecamatan ?></td>
                                                        </tr>
                                                        <tr>
                                                            <th class="col-5 p-2">Agama</th>
                                                            <td class="p-2">:</td>
                                                            <td class="p-2"><?= $dt->agama ?></td>
                                                        </tr>
                                                        <tr>
                                                            <th class="col-5 p-2">Pekerjaan</th>
                                                            <td class="p-2">:</td>
                                                            <td class="p-2"><?= $dt->pekerjaan ?></td>
                                                        </tr>
                                                        <tr>
                                                            <th class="col-5 p-2">Kewarganegaraan</th>
                                                            <td class="p-2">:</td>
                                                            <td class="p-2"><?= $dt->kewarganegaraan ?></td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                            </div>
                                        ...
                                        <div class="col-md-13">
                                            <div class="card card-primary">
                                                <div class="card-header">
                                                    <h3 class="card-title font-italic">Informasi Saldo Titipan Anggota
                                                    </h3>
                                                </div>
                                                <!-- /.card-header2 -->
                                                <div class="card-body">
