...
<div class="content-wrapper">
    ...
    <section class="content " style="height: 530px;">
        ...
        <div class="card ml-2" style="width:86%;">
            <div class="card-body">
                <form method="POST" action="<?php echo base_url('AgendaUmum_Staf/tambah_AgendaU_Bkeanggotaan') ?>"
                    ...
                    <div class="card-footer mt-4" style="width: 100%; margin-bottom: -15px;">
                        ...
                        <a class="btn btn-danger"
                            href="<?php echo base_url('AgendaUmum_Staf/all_Bkeanggotaan') ?>">Kembali</a>
                    </div>
                </form>
            </div>
        </div>
