    ...
    <section class="content " style="height: 530px;">
        ...
        <div class="card ml-2" style="width:56%;">
            <div class="card-body">
                ...
                <form method="POST" action="<?php echo base_url() . 'DewanPimpinan_StafBRiset/update_Aksi_infoPKTabarru'; ?>">
                    <div class="card-header bg-danger mb-2" style="margin-top: -15px; height: 47px;">
                        <h5 class="font-italic">Informasi Pengembangan Koperasi Tabarru</h5>
                    </div>
                    <div class="form-group">
                        <label class="ml-1">Waktu Informasi diposting</label>
                        <input type="hidden" id="id_infoPKTabarru" name="id_infoPKTabarru" class="form-control"
                            value="<?php echo $ag->id_infoPKTabarru ?>">
                    ...
                    <div class="card-footer mt-4" style="width: 100%; margin-bottom: -15px;">
                        ...
                        <a class="btn btn-danger"
                            href="<?php echo base_url('DewanPimpinan_StafBRiset/indexInfoPKTabarru') ?>">Kembali</a>
                    </div>
                </form>
                <?php endforeach; ?>
            </div>
