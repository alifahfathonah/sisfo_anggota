...
<div class="content-wrapper">
    <div class="content-header" style="margin-top: -5px;">
        <div class="row">
            <div class="col-sm-7">
                <h4 class="m-0 text-lightgray text-bold ml-2">Tambah Informasi Pengembangan Koperasi Tijarah</h4>
            </div>
        </div>
    </div>
    ...
    <section class="content" style="margin-bottom: -20px;">
        ...
        <div class="card ml-2" style="width:56%;">
            <div class="card-body">
                <form method="POST" action="<?php echo base_url() . 'DewanPimpinan_StafBRiset/add_Aksi_infoPKTijarah'; ?>">
                    <div class="card-header bg-info mb-2" style="margin-top: -15px; height: 47px;">
                        <h5 class="font-italic">Informasi Pengembangan Koperasi Tijarah</h5>
                    </div>
                    ...
                    <div class="card-footer mt-4" style="width: 100%; margin-bottom: -15px;">
                        ...
                        <a class="btn btn-danger" href="<?php echo base_url('DewanPimpinan_StafBRiset/indexInfoPKTijarah') ?>">Kembali</a>
                    </div>
                </form>
            </div>
        </div>
