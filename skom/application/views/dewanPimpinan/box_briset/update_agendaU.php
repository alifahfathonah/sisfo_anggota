    ...
    <section class="content ">
        ...
        <div class="card" style="width:80%;">
            <div class="card-body">
                ...
                <form method="POST" action="<?php echo base_url() . 'AgendaUmum_Staf/updateAgendaU_aksi_Briset'; ?>">
                    ...
                    <a class="btn btn-danger" href="<?php echo base_url('AgendaUmum_Staf/all_Briset') ?>">Kembali</a>
                </form>
                <?php endforeach; ?>
            </div>
        </div>
