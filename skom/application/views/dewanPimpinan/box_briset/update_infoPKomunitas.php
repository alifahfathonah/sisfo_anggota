    ...
    <section class="content " style="height: 530px;">
        ...
        <div class="card ml-2" style="width:56%;">
            <div class="card-body">
                ...
                <form method="POST" action="<?php echo base_url() . 'DewanPimpinan_StafBRiset/update_Aksi_infoPKomunitas'; ?>">
                    ...
                    <div class="form-group">
                        ...
                        <input type="hidden" id="id_infoPK" name="id_infoPK" class="form-control"
                            value="<?php echo $ag->id_infoPK ?>">
                    ...
                    <div class="card-footer mt-4" style="width: 100%; margin-bottom: -15px;">
                        ...
                        <a class="btn btn-danger"
                            href="<?php echo base_url('DewanPimpinan_StafBRiset/indexInfoPKomunitas') ?>">Kembali</a>
                    </div>
                </form>
                <?php endforeach; ?>
            </div>
