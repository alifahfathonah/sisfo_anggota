...
<div class="content-wrapper">
    <div class="content-header" style="margin-top: -5px;">
        <div class="row">
            <div class="col-sm-5">
                <h4 class="m-0 text-lightgray text-bold ml-2">Tambah Informasi Pengembangan Riset</h4>
            </div>
        </div>
    </div>
    ...
    <section class="content" style="margin-bottom: -20px;">
        ...
        <div class="card ml-2" style="width:56%;">
            <div class="card-body">
                <form method="POST" action="<?php echo base_url() . 'DewanPimpinan_StafBRiset/add_Aksi_infoPRiset'; ?>">
                    ...
                    <div class="card-footer mt-4" style="width: 100%; margin-bottom: -15px;">
                        ...
                        <a class="btn btn-danger" href="<?php echo base_url('DewanPimpinan_StafBRiset/indexInfoRiset') ?>">Kembali</a>
                    </div>
                </form>
            </div>
        </div>
