    ...
    <section class="content " style="height: 530px;">
        ...
        <div class="card ml-2" style="width:86%;">
            <div class="card-body">
                ...
                <form method="POST"
                    action="<?php echo base_url() . 'DewanPimpinan_StafBPendidikan/update_Aksi_agendaK'; ?>">
                    ...
                    <div class="row" style="height:345px;">
                        ...
                        <div class="col-md-4 mx-auto">
                            <div class="form-group">
                                ...
                                <input type="hidden" id="id_agendaK" name="id_agendaK" class="form-control"
                                    value="<?php echo $ag->id_agendaK ?>">
