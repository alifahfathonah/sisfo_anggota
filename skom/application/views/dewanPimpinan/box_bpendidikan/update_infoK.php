    ...
    <section class="content " style="height: 530px;">
        ...
        <div class="card ml-2" style="width:56%;">
            <div class="card-body">
                ...
                <form method="POST"
                    action="<?php echo base_url() . 'DewanPimpinan_StafBPendidikan/update_Aksi_infoK'; ?>">
                    <div class="card-header bg-gray mb-2" style="margin-top: -15px; height: 47px;">
                        <h5 class="font-italic">Informasi Kuttab</h5>
                    </div>
                    <div class="form-group">
                        <label class="ml-1">Waktu Informasi diposting</label>
                        <input type="hidden" id="id_infoK" name="id_infoK" class="form-control"
                            value="<?php echo $ag->id_infoK ?>">
                    ...
                    <div class="card-footer mt-4" style="width: 100%; margin-bottom: -15px;">
                        ...
                        <a class="btn btn-danger"
                            href="<?php echo base_url('DewanPimpinan_StafBPendidikan/indexInfoK') ?>">Kembali</a>
                    </div>
                </form>
                <?php endforeach; ?>
            </div>
