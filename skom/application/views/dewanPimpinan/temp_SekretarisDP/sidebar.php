      ...
      <div class="sidebar">
          ...
          <nav class="mt-2">
              <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                  ...
                  <li class="nav-item">
                      <a href="<?= base_url('DewanPimpinan_Sekretaris'); ?>" class="nav-link">
                  ...
                  <li class="nav-item">
                      <a href="<?= base_url('DewanPimpinan_Sekretaris'); ?>/profile_sekretaris" class="nav-link">
                          <i class="fas fa-user nav-icon"></i>
                          <p>Profil Sekretaris</p>
                      </a>
                  </li>
                  <li class="nav-item">
                      <a href="<?= base_url('AgendaUmum'); ?>/all_Asekretaris" class="nav-link">
                          <i class="fas fa-book nav-icon"></i>
                          <p>Daftar Agenda Umum</p>
                      </a>
                  </li>
                  <li class="nav-item">
                      <a href="<?= base_url('DewanPimpinan_Sekretaris'); ?>/dokumenSekretaris" class="nav-link">
                  ...
                  <li class="nav-item">
                      <a href="<?= base_url('DewanPimpinan_Sekretaris/change_passwordSekretaris'); ?>" class="nav-link">
                  ...
                  <li class="nav-item">
                      <a href="<?= base_url('user_komunitas/sekretaris_d_p'); ?>" class="nav-link">
