    ...
    <section class="content ">
        ...
        <div class="card" style="width:80%;">
            <div class="card-body">
                ...
                <?php echo form_open_multipart('DewanPimpinan_Ketua/updateDokumen_dketua_aksi'); ?>
                ...
                <a class="btn btn-danger" href="<?php echo base_url('DewanPimpinan_Ketua/dokumenKetua') ?>">Kembali</a>
                </form>
                <?php endforeach; ?>
            </div>
        </div>
