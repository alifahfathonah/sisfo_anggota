      ...
      <div class="sidebar">
          ...
          <nav class="mt-2">
              <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                  ...
                  <li class="nav-item">
                      <a href="<?= base_url('DewanPimpinan_StafBPelatihan'); ?>" class="nav-link">
                  ...
                  <li class="nav-item">
                      <a href="<?= base_url('DewanPimpinan_StafBPelatihan'); ?>/profile_bpelatihan" class="nav-link">
                          <i class="fas fa-user nav-icon"></i>
                          <p>Profil</p>
                      </a>
                  </li>
                  <li class="nav-item">
                      <a href="<?= base_url('DewanPimpinan_StafBPelatihan'); ?>/portalPelatihan" class="nav-link">
                          <i class="fas fa-code-branch nav-icon"></i>
                          <p>Portal Pelatihan Usaha</p>
                      </a>
                  </li>
                  <li class="nav-item">
                      <a href="<?= base_url('AgendaUmum_Staf'); ?>/all_Bpelatihan" class="nav-link">
                  ...
                  <li class="nav-item">
                      <a href="<?= base_url('DewanPimpinan_StafBPelatihan/change_passwordBPelatihan'); ?>"
                          class="nav-link">
                  ...
                  <li class="nav-item">
                      <a href="<?= base_url('user_komunitas/staf_b_pelatihan'); ?>" class="nav-link">
