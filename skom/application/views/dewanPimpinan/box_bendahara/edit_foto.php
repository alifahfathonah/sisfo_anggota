        ...
        <div class="container-fluid">
            ...
            <div class="row ml-1">
                ...
                <div class="card ml-1" style="width:31%; height: 150px;">
                    <div class="card-body">
                        <?php echo form_open_multipart('DewanPimpinan_Bendahara/update_aksi_fotoBendahara'); ?>
                        ...
                        <div class="card-footer" style="width: 100%;">
                            ...
                            <a class="btn btn-danger"
                                href="<?php echo base_url('DewanPimpinan_Bendahara/profile_bendahara') ?>">Kembali</a>
                        </div>
                    </div>
                </div>
