      ...
      <div class="sidebar">
          ...
          <nav class="mt-2">
              <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                  ...
                  <li class="nav-item">
                      <a href="<?= base_url('DewanPimpinan_StafBRiset'); ?>" class="nav-link">
                  ...
                  <li class="nav-item">
                      <a href="<?= base_url('DewanPimpinan_StafBRiset'); ?>/profile_briset" class="nav-link">
                          <i class="fas fa-user nav-icon"></i>
                          <p>Profil</p>
                      </a>
                  </li>
                  <li class="nav-item">
                      <a href="<?= base_url('DewanPimpinan_StafBRiset'); ?>/PortalKI" class="nav-link">
                          <i class="fas fa-code-branch nav-icon"></i>
                          <p>Portal Kelola Informasi</p>
                      </a>
                  </li>
                  <li class="nav-item">
                      <a href="<?= base_url('AgendaUmum_Staf'); ?>/all_Briset" class="nav-link">
                  ...
                  <li class="nav-item">
                      <a href="<?= base_url('DewanPimpinan_StafBRiset/change_passwordBRiset'); ?>" class="nav-link">
                  ...
                  <li class="nav-item">
                      <a href="<?= base_url('user_komunitas/staf_br_pengembangan'); ?>" class="nav-link">
