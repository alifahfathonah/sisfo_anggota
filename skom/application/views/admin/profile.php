...
<div class="content-wrapper">
    <div class="content-header" style="margin-top: -5px; margin-bottom: -9px;">
        <div class="row">
            <div class="col-sm-5">
                <h4 class="text-lightgray text-bold ml-2">Detail Profile</h4>
            </div>
        </div>
    </div>
                        ...
                        <div class="card-body box-profile">
                            ...
                            <ul class="list-group list-group-unbordered mb-3">
                                <li class="list-group-item">
                                    <b>Jabatan</b> <a class="float-right"><?= $user['pangkat']; ?>
                                    </a>
                                </li>
                                <li class="list-group-item">
                                    <b>Status</b> <a class="btn btn-success float-right" style="color: #ffff;">
                                        <?php echo $user['status_aktif']; ?>
                                    </a>
                                </li>
                            </ul>
                        </div>
                            ...
                            <table class="table table-sm">
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="table-dark">
                                            <a href="<?= base_url('Admin'); ?>/edit_profile" class="nav-link p-1">
                                    ...
                                    <tr>
                                        ...
                                        <td class="table-dark">
                                            <a href="<?= base_url('Admin'); ?>/edit_foto" class="nav-link p-1">
                                                <button class="btn btn-warning float-right">
                                                    <i class="nav-icon far fa-edit"></i>
                                                    </li>
                                                </button>
