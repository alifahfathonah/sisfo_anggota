    ...
    <section class="content mt-1">
        ...
        <div class="card ml-2" style="width: 86%;">
            <div class="card bg-success mb-0" style="height: 40px;">
                <p class="float-left" style="margin-top: 7px; margin-left: 22px;">Pengisian Data Diri Anggota :
                </p>
            </div>
            <div class="card-body">
                <form method="POST" action="<?php echo base_url('admin/tambahData_Agt'); ?>"
                    ...
                    <div class="row" style="height:300px;">
                        ...
                        <div class="col-md-3 mx-auto">
                            <div class="form-group">
                                ...
                                <input type="number" name="saldo_uang" class="form-control" placeholder="(Rupiah)">
                                <?php echo form_error('saldo_uang', '<div class="text-danger small">', '</div>') ?>
                            </div>
                            <div class="form-group">
                                <label class="ml-2">Saldo Titipan Emas</label>
                                <input type="number" name="saldo_emas" class="form-control" placeholder="(gram)">
