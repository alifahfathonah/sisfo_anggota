      ...
      <div class="sidebar">
          ...
          <nav class="mt-2">
              <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                  ...
                  <li class="nav-item">
                      <a href="<?= base_url('super_admin'); ?>/profile" class="nav-link">
                          <i class="fas fa-user nav-icon"></i>
                          <p>Profile</p>
                      </a>
                  </li>
                  <li class="nav-item">
                      <a href="<?= base_url('super_admin'); ?>/list_admin" class="nav-link">
                          <i class="fas fa-users nav-icon"></i>
                          <p>Pendaftaran Anggota</p>
                      </a>
                  </li>
                  <li class="nav-item">
                      <a href="<?= base_url('super_admin'); ?>/data_hakakses" class="nav-link">
                          <i class="far fa-address-card nav-icon"></i>
                          <p>Hak Akses</p>
                      </a>
                  </li>
                  <li class="nav-item">
                      <a href="<?= base_url('super_admin'); ?>/posisiAdmin" class="nav-link">
                  ...
                  <li class="nav-item">
                      <a href="<?= base_url('Super_Admin/change_password'); ?>" class="nav-link">
                  ...
                  <li class="nav-item">
                      <a href="<?= base_url('Auth/logoutSAdmin'); ?>" class="nav-link">
