        ...
        <div class="container-fluid">
            ...
            <div class="row ml-1">
                <div class="card text-white ml-2" style="max-width: 18rem; border: 2px solid;">
                    <div class="card-body">
                        <img class="card-img" src="<?php echo base_url(); ?>assets/img/<?php echo $user['foto']; ?>"
                            style="width: 100px; height:100px;">
                    </div>
                </div>
                <div class="card ml-1" style="width:31%; height: 150px;">
                    <div class="card-body">
                        <?php echo form_open_multipart('DewanUlama_Sekretaris/update_aksi_fotoSekretaris'); ?>
                        ...
                        <div class="card-footer" style="width: 100%;">
                            ...
                            <a class="btn btn-danger"
                                href="<?php echo base_url('DewanUlama_Sekretaris/profile_sekretaris') ?>">Kembali</a>
                        </div>
                    </div>
                </div>
