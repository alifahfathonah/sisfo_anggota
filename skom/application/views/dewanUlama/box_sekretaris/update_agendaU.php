    ...
    <section class="content ">
        ...
        <div class="card" style="width:80%;">
            <div class="card-body">
                ...
                <form method="POST" action="<?php echo base_url() . 'AgendaUmum_DU/updateAgendaU_aksi_Asekretaris'; ?>">
                    ...
                    <a class="btn btn-danger" href="<?php echo base_url('AgendaUmum_DU/all_Asekretaris') ?>">Kembali</a>
                </form>
                <?php endforeach; ?>
            </div>
        </div>
