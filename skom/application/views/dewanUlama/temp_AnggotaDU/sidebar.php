      ...
      <div class="sidebar">
          ...
          <nav class="mt-2">
              <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                  ...
                  <li class="nav-item">
                      <a href="<?= base_url('DewanUlama_Anggota'); ?>" class="nav-link">
                  ...
                  <li class="nav-item">
                      <a href="<?= base_url('DewanUlama_Anggota'); ?>/profile_anggota" class="nav-link">
                          <i class="fas fa-user nav-icon"></i>
                          <p>Profil</p>
                      </a>
                  </li>
                  <li class="nav-item">
                      <a href="<?= base_url('AgendaUmum_DU'); ?>/all_Aanggota" class="nav-link">
                  ...
                  <li class="nav-item">
                      <a href="<?= base_url('DewanUlama_Anggota/change_passwordAnggota'); ?>" class="nav-link">
                  ...
                  <li class="nav-item">
                      <a href="<?= base_url('user_komunitas/anggota_d_u'); ?>" class="nav-link">
