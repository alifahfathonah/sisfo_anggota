...
class DewanCendekiawan_Ketua extends CI_Controller
{
    ...
    //Zona Ketua Dewan Cendekiawan
    public function index()
    {
        $title['title'] = 'Dasboard Ketua Dewan Cendekiawan';
        ...
        $this->load->view('dewanCendekiawan/indexKetua', $data);
    ...
    public function profile_ketua()
    {
        ...
        $this->load->view('dewanCendekiawan/temp_KetuaDC/sidebar');
        $this->load->view('templates/navbar', $data);
        $this->load->view('dewanCendekiawan/box_ketua/profile_ketua', $data);
        $this->load->view('templates/footer');
    }
    ...
    public function edit_profile()
    {
        ...
        $this->load->view('dewanCendekiawan/temp_KetuaDC/sidebar');
        $this->load->view('templates/navbar', $data);
        $this->load->view('dewanCendekiawan/box_ketua/edit_profile', $data);
        $this->load->view('templates/footer');
    }
    ...
    public function update_aksi()
    {
        ...
        redirect('DewanCendekiawan_Ketua/profile_ketua');
    }

    public function edit_fotoKetua()
    {
        ...
        $this->load->view('dewanCendekiawan/temp_KetuaDC/sidebar');
        $this->load->view('templates/navbar', $data);
        $this->load->view('dewanCendekiawan/box_ketua/edit_foto', $data);
        $this->load->view('templates/footer');
    }

    public function update_aksi_fotoKetua()
    {
        $id             = $this->input->post('id_user');
        $foto           = $_FILES['foto'];
        if ($foto = '') {
        ...
        redirect('DewanCendekiawan_Ketua/edit_fotoKetua');
    }
    ...
    public function change_password()
    {
        ...
        $this->load->view('dewanCendekiawan/temp_KetuaDC/sidebar');
        $this->load->view('templates/navbar', $data);
        $this->load->view('dewanCendekiawan/box_ketua/ubah_pass');
        $this->load->view('templates/footer');
    }
    ...
    public function change_pass()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            if (!password_verify($current, $data['user']['password'])) {
                ...
                redirect('DewanCendekiawan_Ketua/change_pass');
            } else {
                if ($current == $new) {
