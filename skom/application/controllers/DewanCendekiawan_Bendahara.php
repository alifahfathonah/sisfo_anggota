...
class DewanCendekiawan_Bendahara extends CI_Controller
{
    ...
    // Zona Bendahara Dewan Cendekiawan
    public function index()
    {
        $title['title'] = 'Dasboard Bendahara Dewan Cendekiawan';
        ...
        $this->load->view('dewanCendekiawan/indexBendahara', $data);
    ...
    public function profile_bendahara()
    {
        ...
        $this->load->view('dewanCendekiawan/temp_BendaharaDC/sidebar');
        $this->load->view('templates/navbar', $data);
        $this->load->view('dewanCendekiawan/box_bendahara/profile_bendahara', $data);
        $this->load->view('templates/footer');
    }
    ...
    public function edit_profileBendahara()
    {
        ...
        $this->load->view('dewanCendekiawan/temp_BendaharaDC/sidebar');
        $this->load->view('templates/navbar', $data);
        $this->load->view('dewanCendekiawan/box_bendahara/edit_profile', $data);
        $this->load->view('templates/footer');
    }
    ...
    public function update_aksiBendahara()
    {
        ...
        redirect('DewanCendekiawan_Bendahara/profile_bendahara');
    }
    ...
    public function edit_fotoBendahara()
    {
        ...
        $this->load->view('dewanCendekiawan/temp_BendaharaDC/sidebar');
        $this->load->view('templates/navbar', $data);
        $this->load->view('dewanCendekiawan/box_bendahara/edit_foto', $data);
        $this->load->view('templates/footer');
    }
    ...
    public function update_aksi_fotoBendahara()
    {
        ...
        redirect('DewanCendekiawan_Bendahara/edit_fotoBendahara');
    }
    ...
    public function change_passwordBendahara()
    {
        ...
        $this->load->view('dewanCendekiawan/temp_BendaharaDC/sidebar');
        $this->load->view('templates/navbar', $data);
        $this->load->view('dewanCendekiawan/box_bendahara/ubah_pass');
        $this->load->view('templates/footer');
    }
    ...
    public function change_passBendahara()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            if (!password_verify($current, $data['user']['password'])) {
                ...
                redirect('DewanCendekiawan_Bendahara/change_passBendahara');
            } else {
                if ($current == $new) {
