...
class DewanUlama_Ketua extends CI_Controller
{
    ...
    //Zona Ketua Dewan Ulama
    public function index()
    {
        $title['title'] = 'Dasboard Ketua Dewan Ulama';
        ...
        $this->load->view('dewanUlama/indexKetua', $data);
    ...
    public function profile_ketua()
    {
        ...
        $this->load->view('dewanUlama/temp_KetuaDU/sidebar');
        $this->load->view('templates/navbar', $data);
        $this->load->view('dewanUlama/box_ketua/profile_ketua', $data);
        $this->load->view('templates/footer');
    }
    ...
    public function edit_profile()
    {
        ...
        $this->load->view('dewanUlama/temp_KetuaDU/sidebar');
        $this->load->view('templates/navbar', $data);
        $this->load->view('dewanUlama/box_ketua/edit_profile', $data);
        $this->load->view('templates/footer');
    }
    ...
    public function update_aksi()
    {
        ...
        redirect('DewanUlama_Ketua/profile_ketua');
    }
    ...
    public function edit_fotoKetua()
    {
        ...
        $this->load->view('dewanUlama/temp_KetuaDU/sidebar');
        $this->load->view('templates/navbar', $data);
        $this->load->view('dewanUlama/box_ketua/edit_foto', $data);
        $this->load->view('templates/footer');
    }
    ...
    public function update_aksi_fotoKetua()
    {
        ...
        redirect('DewanUlama_Ketua/edit_fotoKetua');
    }
    ...
    public function change_password()
    {
        ...
        $this->load->view('dewanUlama/temp_KetuaDU/sidebar');
        $this->load->view('templates/navbar', $data);
        $this->load->view('dewanUlama/box_ketua/ubah_pass');
        $this->load->view('templates/footer');
    }
    ...
    public function change_pass()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            if (!password_verify($current, $data['user']['password'])) {
                ...
                redirect('DewanUlama_Ketua/change_pass');
            } else {
                if ($current == $new) {
