...
class DewanUlama_Anggota extends CI_Controller
{
    ...
    {
        $title['title'] = 'Dasboard Anggota Dewan Ulama';
        ...
        $this->load->view('dewanUlama/indexAnggota', $data);
        $this->load->view('templates/footer');
    }

    public function profile_anggota()
    {
        $title['title'] = 'Profile Anggota Dewan Ulama';
        ...
        $this->load->view('dewanUlama/temp_AnggotaDU/sidebar');
        $this->load->view('templates/navbar', $data);
        $this->load->view('dewanUlama/box_anggota/profile_anggota', $data);
        $this->load->view('templates/footer');
    }
    ...
    public function edit_profileAnggota()
    {
        ...
        $this->load->view('dewanUlama/temp_AnggotaDU/sidebar');
        $this->load->view('templates/navbar', $data);
        $this->load->view('dewanUlama/box_anggota/edit_profile', $data);
        $this->load->view('templates/footer');
    }
    ...
    public function update_aksiAnggota()
    {
        ...
        redirect('DewanUlama_Anggota/profile_anggota');
    }
    ...
    public function edit_fotoAnggota()
    {
        ...
        $this->load->view('dewanUlama/temp_AnggotaDU/sidebar');
        $this->load->view('templates/navbar', $data);
        $this->load->view('dewanUlama/box_anggota/edit_foto', $data);
        $this->load->view('templates/footer');
    }
    ...
    public function update_aksi_fotoAnggota()
    {
        ...
        redirect('DewanUlama_Anggota/edit_fotoAnggota');
    }
    ...
    public function change_passwordAnggota()
    {
        ...
        $this->load->view('dewanUlama/temp_AnggotaDU/sidebar');
        $this->load->view('templates/navbar', $data);
        $this->load->view('dewanUlama/box_anggota/ubah_pass');
        $this->load->view('templates/footer');
    }
    ...
    public function change_passAnggota()
    {
        ...
        if ($this->form_validation->run() == false) {
			...
			alert-danger" role="alert"> Password Salah.!</div>');
                redirect('DewanUlama_Anggota/change_passAnggota');
            } else {
                if ($current == $new) {
                    $this->session->set_flashdata('message', '<div class="alert
