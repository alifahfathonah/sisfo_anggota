...
class Informasi_tab extends CI_Controller
{
    ...
    public function index()
    {
        ...
        //config
        $config['base_url'] = 'http://localhost/sisfo_anggota/skom/informasi_d_p_StafBKeanggotaan/informasi_tab';
        ...
        $this->load->view('informasi_d_p_StafBKeanggotaan/informasi_tab', $data);
    ...
    public function add_info()
    {
        ...
        $this->load->view('dewanPimpinan/temp_StafBKeanggotaanDP/sidebar');
        $this->load->view('templates/navbar', $data);
        $this->load->view('informasi_d_p_StafBKeanggotaan/add_info_tab', $data);
        $this->load->view('templates/footer');
    }
    ...
    public function add_info_aksi()
    {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            redirect('informasi_d_p_StafBKeanggotaan/informasi_tab');
        }
    }
    ...
    public function update_info($id)
    {
        ...
        $this->load->view('dewanPimpinan/temp_StafBKeanggotaanDP/sidebar');
        $this->load->view('templates/navbar', $data);
        $this->load->view('informasi_d_p_StafBKeanggotaan/update_info_tab', $data);
        $this->load->view('templates/footer');
    }
