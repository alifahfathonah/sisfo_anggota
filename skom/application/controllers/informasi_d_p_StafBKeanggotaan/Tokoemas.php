...
class Tokoemas extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->load->view('informasi_d_p_StafBKeanggotaan/tokoemas', $data);
    ...
    public function update_tokoemas($id)
    {
        ...
        $this->load->view('dewanPimpinan/temp_StafBKeanggotaanDP/sidebar');
        $this->load->view('templates/navbar', $data);
        $this->load->view('informasi_d_p_StafBKeanggotaan/update_tokoemas', $data);
        $this->load->view('templates/footer');
    }
    ...
    public function update_tokoemas_aksi()
    {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            <strong>Toko Emas berhasil diupdate !</strong>
            <button type="button" class="close" data-dismiss="alert" aria-label="Close">  <span aria-hidden="true">&times;</span>
			</button>
            </div>');

            redirect('informasi_d_p_StafBKeanggotaan/tokoemas');
        }
    }
