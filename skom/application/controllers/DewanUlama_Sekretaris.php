...
class DewanUlama_Sekretaris extends CI_Controller
{
    ...
    // Zona Sekretaris Dewan Ulama
    public function index()
    {
        $title['title'] = 'Dasboard Sekretaris Dewan Ulama';
        ...
        $this->load->view('dewanUlama/indexSekretaris', $data);
    ...
    public function profile_sekretaris()
    {
        ...
        $this->load->view('dewanUlama/temp_SekretarisDU/sidebar');
        $this->load->view('templates/navbar', $data);
        $this->load->view('dewanUlama/box_sekretaris/profile_sekretaris', $data);
        $this->load->view('templates/footer');
    }
    ...
    public function edit_profileSekretaris()
    {
        ...
        $this->load->view('dewanUlama/temp_SekretarisDU/sidebar');
        $this->load->view('templates/navbar', $data);
        $this->load->view('dewanUlama/box_sekretaris/edit_profile', $data);
        $this->load->view('templates/footer');
    }
    ...
    public function update_aksiSekretaris()
    {
        ...
        redirect('DewanUlama_Sekretaris/profile_sekretaris');
    }
    ...
    public function edit_fotoSekretaris()
    {
        ...
        $this->load->view('dewanUlama/temp_SekretarisDU/sidebar');
        $this->load->view('templates/navbar', $data);
        $this->load->view('dewanUlama/box_sekretaris/edit_foto', $data);
        $this->load->view('templates/footer');
    }
    ...
    public function update_aksi_fotoSekretaris()
    {
        ...
        redirect('DewanUlama_Sekretaris/edit_fotoSekretaris');
    }
    ...
    public function change_passwordSekretaris()
    {
        ...
        $this->load->view('dewanUlama/temp_SekretarisDU/sidebar');
        $this->load->view('templates/navbar', $data);
        $this->load->view('dewanUlama/box_sekretaris/ubah_pass');
        $this->load->view('templates/footer');
    }
    ...
    public function change_passSekretaris()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            if (!password_verify($current, $data['user']['password'])) {
                ...
                redirect('DewanUlama_Sekretaris/change_passSekretaris');
            } else {
                if ($current == $new) {
