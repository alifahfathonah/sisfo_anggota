...
class agendaUDU_Model extends CI_Model
{
    ...
    public function allData_menurutBPendidikan()
    {
        $this->db->select('*');
        $this->db->from('agendaumum_K');
        $this->db->where('pembuat_agenda', 'Bidang Pendidikan');
        $query = $this->db->get();
        return $query->result();
    }
    public function allData_menurutBPelatihan()
    {
        $this->db->select('*');
        $this->db->from('agendaumum_K');
        $this->db->where('pembuat_agenda', 'Bidang Pelatihan');
        $query = $this->db->get();
        return $query->result();
    }
    public function allData_menurutBKeanggotaan()
    {
        $this->db->select('*');
        $this->db->from('agendaumum_K');
        $this->db->where('pembuat_agenda', 'Bidang Keanggotaan');
        $query = $this->db->get();
        return $query->result();
    }
    public function allData_menurutBRiset()
    {
        $this->db->select('*');
        $this->db->from('agendaumum_K');
        $this->db->where('pembuat_agenda', 'Bidang Riset & Pengembangan');
        $query = $this->db->get();
        return $query->result();
    }
    //Dewan Ulama
