    ...
    <header id="header" class="fixed-top">
        ...
        <nav class="nav-menu d-none d-lg-block">
                <ul>
                    ...
                    <li class="active"><a href="<?= base_url('anggota_t_j/profil') ?>">Profil</a></li>
                                                            ...
                                                            <div class="row m-l-0 m-r-0">
                                                                <div class="col-sm-4 bg-c-lite-green user-profile">
                                                                    <div class="card-block text-center text-white">
                                                                        <div class="m-b-25"> <img style="width:60%" src="<?= base_url('skom/assets/photo/') . $user['foto']; ?>" class="img-radius" alt="User-Profile-Image"> </div>
                                                                        <p class="f-w-600"><?= $user['nama']; ?></p>
                                                                        <h6>NIK : <?= $user['nik']; ?></h6> <i class=" mdi mdi-square-edit-outline feather icon-edit m-t-10 f-16"></i>
                                                                    </div>
                                                                </div>
                                                                <div class="col-sm-8">
