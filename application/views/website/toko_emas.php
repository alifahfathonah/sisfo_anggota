...
<body>
	...
	<header id="header" class="fixed-top">
		<div class="container-fluid d-flex ">
			...
			<div class="logo mr-auto">
				<h1 class="text-light"><a href="">TOKO EMAS</span></a></h1>
				...
				<ul>
					...
					<li class="drop-down"><a href="#">Jasa</a>
						<ul>
							...
							<li class="active"><a href="<?= base_url('website/tokoemas') ?>">Toko Emas</a></li>
	...
	<main id="main">
		...
		<section id="toko_emas" class="services">
			<div class="container">
							...
							<div class="row justify-content-between">
								<div class="col-lg-5 col-md-12 d-flex align-items-center justify-content-center about-img">
									<?php foreach ($konten_tokoemas as $t) : ?>
										<span class="border border-success"><img src="<?= base_url() . 'skom/assets/photo/' . $t->photo ?>" class="img-fluid" alt="" data-aos="zoom-in" style="max-width: 350px; max-height: 350px;">
										</span></div>
								<div class="col-lg-6 pt-5 pt-lg-0">
									<h3 data-aos="fade-up">Toko Emas</h3>
									<br>
