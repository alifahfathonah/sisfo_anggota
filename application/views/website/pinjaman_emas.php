...
<body>
  ...
  <header id="header" class="fixed-top">
    <div class="container-fluid d-flex ">
      ...
      <div class="logo mr-auto">
        <h1 class="text-light"><a href="">PINJAMAN EMAS</span></a></h1>
        ...
        <ul>
          ...
          <li class="drop-down"><a href="#">Jasa</a>
            <ul>
              ...
              <li class="active"><a href="<?= base_url('website/pinjamanemas') ?>">Pinjaman Emas</a></li>
            </ul>
          </li>
  ...
  <main id="main">
    ...
    <section id="pinjamanemas" class="services">
      <div class="container">
              ...
              <div class="row justify-content-between">
                <div class="col-lg-5 d-flex align-items-center justify-content-center about-img">
                  <?php foreach ($konten_pinjamanemas as $p) : ?>
                    <span class="border border-success"><img src="<?= base_url() . 'skom/assets/photo/' . $p->photo ?>" class="img-fluid" alt="" data-aos="zoom-in" style="max-width: 350px; max-height: 350px;">
                    </span></div>
                <div class="col-lg-6 pt-5 pt-lg-0">
                  <h3 data-aos="fade-up">Pinjaman Emas</h3>
                  <br>
