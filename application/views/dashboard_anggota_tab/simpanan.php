            ...
            <nav class="nav-menu d-none d-lg-block">
                <ul>
                    ...
                    <li class="drop-down active"><a href="#">Layanan & Produk</a>
                        <ul>
                            <li class="active"><a href="<?= base_url('anggota_t_j_tab/simpanan') ?>">Simpanan</a></li>
                                    ...
                                    <div class="blog-text">
                                        ...
                                        <div class="card shadow mb-4">
                                            <div class="card-header py-3">
                                                <h5 class="m-0 font-weight-bold text-primary">Informasi Simpanan Anggota</h5>
                                            </div>
                                            <div class="card-body">
                                                <div class="table-responsive">
                                                    <table class="table table-bordered" id="table1" width="100%" cellspacing="0">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            $JSimpananSukarela = 0;
                                                            $no = 1;
                                                            foreach ($simpananbq as $s) : ?>
                                                                <tr align="center">
                                                                    <td style="width: 2%;"><?= $no++ ?></td>
                                                                    <td style="width: 10%;"><?= $s->tgl_simpan ?></td>
                                                                    <td><?php echo number_format($s->simpanan_pokok, 0, ',', '.'); ?></td>
                                                                    <td><?php echo number_format($s->simpanan_wajib, 0, ',', '.'); ?></td>
                                                                    <td><?php echo number_format($s->simpanan_sukarela, 0, ',', '.'); ?></td>
                                                                    <?php $JSimpananPokok += $s->simpanan_pokok; ?>
                                                                    <?php $JSimpananWajib += $s->simpanan_wajib; ?>
                                                                    <?php $JSimpananSukarela += $s->simpanan_sukarela; ?>
                                                                </tr>
                                                            <?php endforeach; ?>

                                                            <tr>
                                                                <td colspan="2" class="text-center"><b>Jumlah Total</b></td>
                                                                <td><b><?= 'Rp. ' . number_format($JSimpananPokok, 0, ',', '.') ?></b></td>
                                                                <td><b><?= 'Rp. ' . number_format($JSimpananWajib, 0, ',', '.') ?></b></td>
                                                                <td><b><?= 'Rp. ' . number_format($JSimpananSukarela, 0, ',', '.') ?></b></td>
                                                            </tr>
