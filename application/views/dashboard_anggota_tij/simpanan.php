    ...
    <header id="header" class="fixed-top">
        <div class="container d-flex">
            ...
            <div class="logo mr-auto">
                ...
                <a href="<?= base_url('website') ?>"><img src="<?= base_url() ?>assets_dashboard/img/logo.png" alt=""
                        class="img-fluid"></a>
            </div>
            ...
            <nav class="nav-menu d-none d-lg-block">
                <ul>
                    ...
                    <li class="drop-down active"><a href="#">Layanan & Produk</a>
                        <ul>
                            <li class="active"><a href="<?= base_url('anggota_t_j_tij/simpanan') ?>">Simpanan</a></li>
                            <li><a href="<?= base_url('anggota_t_j_tij/toko_emas') ?>">Toko Emas</a></li>
                            <li class="drop-down"><a href="#">Pembiayaan</a>
                                <ul>
                                    <li><a href="<?= base_url('anggota_t_j_tij/profil_pembiayaan') ?>">Profil
                                            Pembiayaan</a></li>
                                    <li><a href="<?= base_url('anggota_t_j_tij/riwayat_angsuran_pembiayaan') ?>">Riwayat
                                            Angsuran Pembiayaan</a></li>
                                </ul>
                            </li>
                            <li><a href="<?= base_url('anggota_t_j_tij/pinjaman_emas') ?>">Pinjaman Emas</a></li>
                            <li><a href="<?= base_url('anggota_t_j_tij/riwayat_angsuran_tabarru') ?>">Riwayat Angsuran
                                    Tabarru</a></li>
                        </ul>
                    </li>
                    ...
                    <li class="drop-down"><a href="#">Tijarah</a>
                        <ul>
                            <li><a href="<?= base_url("anggota_t_j_tij/usaha_jual_beli_emas"); ?>">Usaha Jual Beli
                                    Emas</a></li>
                            <li><a href="<?= base_url("anggota_t_j_tij/usaha_pembiayaan"); ?>">Usaha Pembiayaan</a></li>
                            <li><a href="<?= base_url("anggota_t_j_tij/keuangan_tijarah"); ?>">Laporan Keuangan
                                    Tijarah</a></li>
                        </ul>
                    </li>
                    <li class="drop-down"><a href="#">Tabarru</a>
                        <ul>
                            <li><a href="<?= base_url("anggota_t_j_tij/usaha_titipan_uang_emas"); ?>">Usaha Titipan Uang
                                    & Emas</a></li>
                            <li><a href="<?= base_url("anggota_t_j_tij/usaha_pinjam_emas"); ?>">Usaha Pinjam Emas</a>
                            </li>
                            <li><a href="<?= base_url("anggota_t_j_tij/laporan_keuangan_tabarru"); ?>">Laporan Keuangan
                                    Tabarru</a></li>
                        </ul>
                    </li>
                    ...
                    <li><a href="<?= base_url('website') ?>"
                            onclick="return confirm('Apakah anda yakin ingin LOG OUT ?')">LOG OUT</a></li>
                        ...
                        <div class="slider-content text-center">
                            <div class="header-bottom">
                                ...
                                <div class="layer3 wow zoomInUp" data-wow-duration="2s" data-wow-delay="1s">
                                    <h2 class="title3"><b>Simpanan</b></h2>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="single-blog">
                                    ...
                                    <div class="blog-text">
                                        <h4>
                                            <a href="#"><b>Simpanan</b></a>
                                        </h4>

                                        <div class="card shadow mb-4">
                                            <div class="card-header py-3">
                                                <h5 class="m-0 font-weight-bold text-primary">Informasi Simpanan Anggota
                                                </h5>
                                            </div>
                                            <div class="card-body">
                                                <div class="table-responsive">
                                                    <table class="table table-bordered" id="table1" width="100%"
                                                        ...
                                                        <?php $n=1; foreach($simpananbyuser as $row): ?>
                                                        <tbody>
                                                            <tr align="center">
                                                                <td><?= $n++; ?></td>
                                                                <td><?= $row->id_anggota ?></td>
                                                                <td><?= $row->tgl_simpan; ?></td>
                                                                <td><?= number_format($row->simpanan_pokok,0,'','.'); ?>
                                                                </td>
                                                                <td><?= number_format($row->simpanan_wajib,0,'','.'); ?>
                                                                </td>
                                                                <td><?= number_format($row->simpanan_sukarela,0,'','.'); ?>
                                                                </td>
                                                            </tr>
                                                        </tbody>
                                                        <?php endforeach; ?>
                                                        <tfoot class="text-center text-bold">
                                                            <tr>
                                                                ...
                                                                <th><?= 'Rp.'.number_format($simpanan_total->j_simpanan_pokok,0,'','.'); ?>
                                                                </th>
                                                                <th><?= 'Rp.'.number_format($simpanan_total->j_simpanan_wajib,0,'','.'); ?>
                                                                </th>
                                                                <th><?= 'Rp.'.number_format($simpanan_total->j_simpanan_sukarela,0,'','.'); ?>
                                                                </th>
                                                            </tr>
                                                        </tfoot>
                                                    </table>
