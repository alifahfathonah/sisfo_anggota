            ...
            <nav class="nav-menu d-none d-lg-block">
                <ul>
                    ...
                    <li class="drop-down active"><a href="#">Komunitas</a>
                        <ul>
                            <li class="active"><a href="<?= base_url("anggota_t_j_tij/kuttab"); ?>">Kuttab</a></li>
                                    ...
                                    <div class="blog-text">
                                        ...
                                        <div class="card shadow mb-4">
                                            <div class="card-header py-3">
                                                <h5 class="m-0 font-weight-bold text-primary">Agenda Kuttab</h5>
                                            </div>
                                            <div class="card-body">
                                        ...
                                        <div class="card shadow mb-4">
                                            <div class="card-header py-3">
                                                <h5 class="m-0 font-weight-bold text-primary">Informasi Kuttab</h5>
                                            </div>
                                            <div class="card-body">
                                                <div class="table-responsive">
                                                    <table class="table table-bordered" width="100%" cellspacing="0">
