                ...
                <ul>
                    ...
                    <li class="drop-down active"><a href="#">Komunitas</a>
                        <ul>
                            ...
                            <li class="active"><a href="<?= base_url("anggota_t_j_tij/agenda_koperasi"); ?>">Agenda Koperasi</a></li>
                        </ul>
                    </li>
                        ...
                        <div class="row">
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="single-blog">
                                    ...
                                    <div class="blog-text">
                                        <h4>
                                            <a href="#"><b>Agenda Koperasi</b></a>
                                        </h4>
                                        <div class="card shadow mb-4">
                                            <div class="card-header py-3">
                                                <h5 class="m-0 font-weight-bold text-primary">Agenda Komunitas Koperasi</h5>
                                            </div>
                                            <div class="card-body">
                                                    ...
                                                    <table class="table table-bordered" id="table1" width="100%" cellspacing="0">
                                                        ...
                                                        <thead>
                                                            <tr>
                                                                ...
                                                                <th class="text-center">Pembuat Agenda</th>
                                                            </tr>
                                                        </thead>
                                                        <tbody>
                                                            <?php $no = 1;
                                                            foreach ($agendaumum_k as $a) : ?>
                                                                <tr align="center">
                                                                    <td style="width: 2%;"><?= $no++ ?></td>
                                                                    <td style="width: 10%;"><?= $a->tanggal ?></td>
                                                                    <td style="width: 10%;"><?= $a->jam ?></td>
                                                                    <td style="width: 20%;"><?= $a->agenda ?></td>
                                                                    <td style="width: 20%;"><?= $a->lokasi ?></td>
                                                                    <td style="width: 20%;"><?= $a->keterangan ?></td>
                                                                    <td style="width: 20%;"><?= $a->pembuat_agenda ?></td>
                                                                </tr>
                                                            <?php endforeach; ?>
                                                        </tbody>
                                                    </table>
