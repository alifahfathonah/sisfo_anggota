                ...
                <ul>
                    ...
                    <li class="drop-down active"><a href="#">Tijarah</a>
                        <ul>
                            ...
                            <li class="active"><a href="<?= base_url("anggota_t_j_tij/usaha_pembiayaan"); ?>">Usaha Pembiayaan</a></li>
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="single-blog">
                                    ...
                                    <div class="blog-text">
                                        ...
                                        <h3>Fungsi Pembiayaan</h3>
                                        <p>Menurut Rivai dan Veithzal (2008:7) Pembiayaan mempunyai peranan yang sangat penting dalam perekonomian. Secara garis besar fungsi pembiayaan di dalam perekonomian, perdagangan, dan keuangan dapat dikemukakan sebagai berikut :</p>
                                        <p>1. Pembiayaan dapat meningkatkan utility (daya guna) dari modal/uang</p>
                                        <p>2. Pembiayaan meningkatkan utility (daya guna) suatu barang</p>
                                        <p>3. Pembiayaan meningkatkan peredaran dan lalu lintas barang</p>
                                        <p>4. Pembiayaan menimbulkan gairah usaha masyarakat</p>
                                        <p>5. Pembiayaan sebagai alat stabilisasi ekonomi</p>
                                    </div>
                                </div>
                            </div>
