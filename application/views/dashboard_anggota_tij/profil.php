        ...
        <div class="container d-flex">
            ...
            <nav class="nav-menu d-none d-lg-block">
                <ul>
                    ...
                    <li class="active"><a href="<?= base_url('anggota_t_j_tij/profil') ?>">Profil</a></li>
                                                            ...
                                                            <div class="row m-l-0 m-r-0">
                                                                <div class="col-sm-4 bg-c-lite-green user-profile">
                                                                    <div class="card-block text-center text-white">
                                                                        <div class="m-b-25"> <img style="width:60%" src="<?= base_url('baitulqirad/assets/photo/') . $data_anggotabq['foto']; ?>" class="img-radius" alt="User-Profile-Image"> </div>
                                                                        <p class="f-w-600"><?= $data_anggotabq['nama_anggota']; ?></p>
                                                                        <h6>NIK : <?= $data_anggotabq['nik']; ?></h6> <i class=" mdi mdi-square-edit-outline feather icon-edit m-t-10 f-16"></i>
                                                                    </div>
                                                                </div>
                                                                <div class="col-sm-8">
                                                                    <div class="card-block">
                                                                        <p class="m-b-20 p-b-5 b-b-default f-w-600"><b>User Profil</b></p>
                                                                        <div class="row">
                                                                            <div class="col-sm-6">
                                                                                <p class="m-b-10 f-w-600">Jabatan</p>
                                                                                <h6 class="text-muted f-w-400">
                                                                                    <?= $data_anggotabq['jabatan']; ?>
                                                                                </h6>
                                                                            </div>
                                                                            <div class="col-sm-6">
                                                                                <p class="m-b-10 f-w-600">Jenis Kelamin</p>
                                                                                <h6 class="text-muted f-w-400"><?= $data_anggotabq['jenis_kelamin']; ?></h6>
                                                                            </div>
                                                                        </div>
                                                                        ...
                                                                        <div class="row">
                                                                            <div class="col-sm-6">
                                                                                ...
                                                                                <h6 class="text-muted f-w-400"><?= $data_anggotabq['tgl_lahir']; ?></h6>
                                                                            </div>
                                                                            <div class="col-sm-6">
                                                                                <p class="m-b-10 f-w-600">Tempat Lahir</p>
                                                                                <h6 class="text-muted f-w-400"><?= $data_anggotabq['tempat_lahir']; ?></h6>
                                                                            </div>
                                                                        </div>
                                                                        <h6 class="m-b-20 m-t-40 p-b-5 b-b-default f-w-600"></h6>
                                                                        <div class="row">
                                                                            <div class="col-sm-6">
                                                                                ...
                                                                                <h6 class="text-muted f-w-400"><?= $data_anggotabq['status_kawin']; ?></h6>
                                                                            </div>
                                                                            <div class="col-sm-6">
                                                                                <p class="m-b-10 f-w-600">Alamat</p>
                                                                                <h6 class="text-muted f-w-400"><?= $data_anggotabq['alamat']; ?></h6>
                                                                            </div>
                                                                        </div>
                                                                        <h6 class="m-b-20 m-t-40 p-b-5 b-b-default f-w-600"></h6>
                                                                        <div class="row">
                                                                            <div class="col-sm-6">
                                                                                ...
                                                                                <h6 class="text-muted f-w-400"><?= $data_anggotabq['no_hp']; ?></h6>
                                                                            </div>
                                                                            <div class="col-sm-6">
                                                                                <p class="m-b-10 f-w-600">Status</p>
                                                                                <h6 class="text-muted f-w-400">
                                                                                    <?php if ($data_anggotabq['status'] == '1') {
