                ...
                <ul>
                    ...
                    <li class="drop-down active"><a href="#">Tabarru</a>
                        <ul>
                            ...
                            <li class="active"><a href="<?= base_url("anggota_t_j_tij/usaha_pinjam_emas"); ?>">Usaha Pinjam Emas</a></li>
                        ...
                        <div class="row">
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="single-blog">
                                    ...
                                    <div class="blog-text">
                                        <h4>
                                            <a href="#"><b>Usaha Pinjam Emas</b></a>
                                        </h4>
                                            <p>Mitra Emas tabarru adalah produk qardh beragun emas dimana koperasi memberikan fasilitas pembiayaan kepada nasabah dengan agunan berupa emas batangan/lantakan (logam mulia) dari nasabah yang bersangkutan dengan mengikuti prinsip qardh dan rahn. Barang emas dimaksud ditempatkan dalam penguasaan dan pemeliharaan Bank dan atas pemeliharaan tersebut Bank mengenakan biaya sewa atas dasar prinsip ijarah.</p>
                                    </div>
                                </div>
                            </div>
