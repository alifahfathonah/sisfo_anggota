                ...
                <ul>
                    ...
                    <li class="drop-down active"><a href="#">Layanan & Produk</a>
                        <ul>
                            ...
                            <li class="drop-down active"><a href="#">Pembiayaan</a>
                                <ul>
                                    <li><a href="<?= base_url('anggota_t_j_tij/profil_pembiayaan') ?>">Profil Pembiayaan</a></li>
                                    <li class="active"><a href="<?= base_url('anggota_t_j_tij/riwayat_angsuran_pembiayaan') ?>">Riwayat Angsuran Pembiayaan</a></li>
                                </ul>
                            </li>
                        ...
                        <div class="row">
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="single-blog">
                                    ...
                                    <div class="blog-text">
                                        <h4>
                                            <a href="#"><b>Riwayat Angsuran</b></a>
                                        </h4>
                                            <div class="card shadow mb-4">
                                            <div class="card-header py-3">
                                                <h5 class="m-0 font-weight-bold text-primary">Riwayat Angsuran Pembiayaan</h5>
                                            </div>
                                            <div class="card-body">
