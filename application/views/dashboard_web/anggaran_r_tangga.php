                ...
                <ul>
                    ...
                    <li class="drop-down active"><a href="#">Tentang Kami</a>
                        <ul>
                            ...
                            <li class="active"><a href="<?= base_url('website/anggaran_r_tangga') ?>">Anggaran Rumah Tangga</a></li>
                        </ul>
                    </li>
                        ...
                        <div class="slider-content text-center">
                            <div class="header-bottom">
                                ...
                                <div class="layer3 wow zoomInUp" data-wow-duration="2s" data-wow-delay="1s">
                                    <h2 class="title3"><b>Anggaran Rumah Tangga</b></h2>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="single-blog">
                                    ...
                                    <div class="blog-text">
                                        <h4>
                                            <a href="#"><b>Anggaran Rumah Tangga</b></a>
                                        </h4>
                                        <p>
                                            .........
                                        </p>
