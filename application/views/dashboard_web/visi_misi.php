                ...
                <ul>
                    ...
                    <li class="drop-down active"><a href="#">Tentang Kami</a>
                        <ul>
                            ...
                            <li class="active"><a href="<?= base_url('website/visi_misi') ?>">VISI MISI</a></li>
                        ...
                        <div class="slider-content text-center">
                            <div class="header-bottom">
                                ...
                                <div class="layer3 wow zoomInUp" data-wow-duration="2s" data-wow-delay="1s">
                                    <h2 class="title3"><b>VISI MISI</b></h2>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="single-blog">
                                    ...
                                    <div class="blog-text">
                                        ...
                                        <p>
                                            Menjadi Koperasi yang mandiri serta dapat mensejahterakan masyarakat sesuai tuntunan Al-Qur’an dan As Sunnah serta berlandaskan Pancasila dan UUD 1945.
                                        </p>
                                    </div>
                                    <br><br>
                                    <div class="blog-text">
                                        ...
                                        <p>
                                            1. Mengembangkan ekonomi sesuai prinsip muamalah syariah<br>
                                            2. Menjadi mitra usaha bagi anggota dan masyarakat<br>
                                            3. Menjadi wadah bagi anggota untuk berinvestasi secara aman dan nyaman sesuai prinsip muamalah syariah.<br>
                                        </p>
                                    </div>
                                </div>
                            </div>
