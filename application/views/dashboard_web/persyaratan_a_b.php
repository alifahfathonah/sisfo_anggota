                    ...
                    <li class="drop-down active"><a href="#">LOG IN</a>
                        <ul>
                            ...
                            <li class="drop-down active"><a href="#">Pendaftaran Anggota</a>
                                <ul>
                                    <li class="active"><a href="<?= base_url('website/persyaratan_a_b') ?>">Persyaratan Anggota Baru</a></li>
                        ...
                        <div class="slider-content text-center">
                            <div class="header-bottom">
                                ...
                                <div class="layer3 wow zoomInUp" data-wow-duration="2s" data-wow-delay="1s">
                                    <h2 class="title3"><b>Persyaratan Anggota Baru</b></h2>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="single-blog">
                                    ...
                                    <div class="blog-text">
                                        <h4>
                                            <a href="#"><b>Persyaratan Anggota Baru</b></a>
                                        </h4>
                                        <p>a.  Warga Negara Indonesia.</p>
                                        <p>b.  Mematuhi semua aturan hukum dan perundangan yang berlaku di Indonesia.</p>
                                        <p>c.  Tidak terdaftar di organisasi/kelompok yang dinyatakan sebagai organisasi/kelompok terlarang oleh Majelis Ulama Indonesia.</p>
                                        <p>d.  Mengisi, menandatangani, dan menyerahkan formulir permohonan untuk menjadi Anggota Koperasi.</p>e.  Melunasi Simpanan Pokok sebesar Rp 100.000 dan Simpanan Wajib sebesar Rp 100.000 pertahun atau Rp 10.000 perbulan.
                                        <p>Melampirkan salinan:</p>
                                        <p>– KTP/SIM/Paspor/KITAS yang masih berlaku (pilih salah satu)</p>
                                        <p>– bukti pelunasan pembayaran Simpanan Pokok dan Simpanan Wajib bulan berjalan</p>
                                        <p>– serta bukti-bukti pendukung lainnya untuk memenuhi persyaratan menjadi Anggota Koperasi</p>
