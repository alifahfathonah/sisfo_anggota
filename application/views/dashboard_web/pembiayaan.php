                ...
                <ul>
                    ...
                    <li class="drop-down active"><a href="#">Layanan</a>
                        <ul>
                            ...
                            <li class="active"><a href="<?= base_url('website/pembiayaan') ?>">Pembiayaan</a></li>
                        ...
                        <div class="slider-content text-center">
                            <div class="header-bottom">
                                ...
                                <div class="layer3 wow zoomInUp" data-wow-duration="2s" data-wow-delay="1s">
                                    <h2 class="title3"><b>Pembiayaan</b></h2>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="single-blog">
                                    ...
                                    <div class="blog-text">
                                        <h4>
                                            <a href="#"><b>Pembiayaan</b></a>
                                        </h4>
                                        <p>
                                            Dalam rangka mewujudkan visi & misi Koperasi, Kami mengeluarkan Produk Pembiayaan untuk memenuhi kebutuhan para anggota meliputi akad Pembiayaan Produktif dan Pembiayaan Konsumtif. 
                                        </p>
                                        <p>
                                            Pembiayaan Produktif yaitu pembiayaan modal kerja dimana pembiayaan yang diguanakan untuk keperluan meningkatkan produksi baik secara kualitatif maupun kuantitatif dalam menjalankan oprasionalnya, pembiayaan modal kerja untuk perdagangan atau peningkatan utility of place dari suatu barang. Pembiayaan produktif digunakan untuk meningkatkan usaha sehingga dapat memperoleh tambahan keuntungan/ laba. Pada pembiayaan produktif menggunakan akad murabahah dan mudharabah.
                                        </p>
                                        <p>
                                            Pembiayaan Konsumtif yaitu pembiayaan yang digunakan untuk memenuhi kebutuhan konsumsi, yang akan habis digunakan untuk memenuhi kebutuhan. Jenis pembiayaan syariah yaitu pembiayaan konsumtif bertujuan untuk pemenuhan kebutuhan sehari-hari yang cepat habis misalnya untuk membeli kebutuhan pokok, membeli sepeda motor, laptop maupun membayar biaya sekolah. Pada pembiayaan konsumtif menggunakan akad murabahah (jual-beli), ijarah, dan qardh. 
                                        </p>
                                        <p>
                                            Dalam konsep pembiayaan yang dilakukan oleh lembaga keuangan syariah menggunakan prinsip jual beli, sewa dan juga bagi hasil.
                                        </p>
                                    </div>
                                </div>
                            </div>
