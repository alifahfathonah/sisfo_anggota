                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="single-blog">
                                    ...
                                    <div class="blog-text">
                                        ...
                                        <p>
                                            Simpanan di Koperasi Tijarah meliputi beberapa jenis yaitu, diantaranya; Simpanan Pokok, Simpanan Wajib, & Simpanan Sukarela.
                                            <br><br>
                                            <b>1. Simpanan Pokok</b>
                                            <br><br>
                                            Simpanan Pokok adalah simpanan yang di bayar sekali pada saat mendaftar menjadi anggota. Besarnya simpanan bergantung dari hasil kesepakatan pengurus dan anggota koperasi. Simpanan hanya bisa di ambil kembali ketika keluar dari keanggotaan Koperasi.
                                            <br><br>
                                            <b>2. Simpanan Wajib</b>
                                            <br><br>
                                            Simpanan Wajib adalah simpanan yang wajib di bayar sebulan sekali. Besarnya simpanan bergantung dari hasil kesepakatan pengurus dan anggota koperasi. Simpanan hanya bisa di ambil kembali ketika keluar dari keanggotaan Koperasi.
                                            <br><br>
                                            <b>3. Simpanan Sukarela</b>
                                            <br><br>
                                            Simpanan Sukarela adalah simpanan yang besarnya tidak di tentukan, tetapi bergantung kepada kemampuan anggota. Simpanan sukarela dapat di setorkan dan diambil setiap saat.
                                            <br><br>
                                        </p>
                                    </div>
                                </div>
