                ...
                <ul>
                    ...
                    <li class="drop-down active"><a href="#">Layanan</a>
                        <ul>
                            ...
                            <li class="active"><a href="<?= base_url('website/pelayanan_pinjaman') ?>">Pelayanan Pinjaman</a></li>
                        ...
                        <div class="slider-content text-center">
                            <div class="header-bottom">
                                ...
                                <div class="layer3 wow zoomInUp" data-wow-duration="2s" data-wow-delay="1s">
                                    <h2 class="title3"><b>Pelayanan Pinjaman</b></h2>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="single-blog">
                                    ...
                                    <div class="blog-text">
                                        <h4>
                                            <a href="#"><b>Pelayanan Pinjaman</b></a>
                                        </h4>
                                        <p>
                                            Pinjaman Emas adalah adalah pemberian kredit dengan sistem pinjam yang diberikan ke seluruh golongan nasabah untuk kebutuhan konsumtif maupun produktif dengan jaminan emas, berupa emas murni.
                                        </p>
                                    </div>
                                </div>
                            </div>
