...
class UbahPassword extends CI_Controller{
...

	{
		...
		$this->load->view('temp_kepalajaminan/header', $data);
		$this->load->view('temp_kepalajaminan/sidebar');
		$this->load->view('kepalajaminan/formUbahPassword', $data);
		$this->load->view('temp_kepalajaminan/footer');
	}
