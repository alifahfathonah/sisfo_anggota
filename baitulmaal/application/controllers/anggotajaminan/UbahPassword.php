...
class UbahPassword extends CI_Controller{
...

	{
		...
		$this->load->view('temp_anggotajaminan/header', $data);
		$this->load->view('temp_anggotajaminan/sidebar');
		$this->load->view('anggotajaminan/formUbahPassword', $data);
		$this->load->view('temp_anggotajaminan/footer');
	}
