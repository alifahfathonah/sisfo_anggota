      ...
      <li class="nav-item">
        ...
        <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <a class="collapse-item" href="<?php echo base_url('bendahara/akun') ?>">COA</a>
            ...
            <a class="collapse-item" href="<?php echo base_url('bendahara/PerubahanModal') ?>">Laporan Perubahan Dana</a>
            <a class="collapse-item" href="<?php echo base_url('bendahara/neraca') ?>">Laporan Posisi Keuangan</a>
            <a class="collapse-item" href="<?php echo base_url('bendahara/piutang') ?>">Data Piutang</a>
          </div>
        </div>
      </li>
