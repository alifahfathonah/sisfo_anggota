...
<i class="fas fa-plus"></i> Tambah Agenda Khusus
</div>
</section>
...
<div class="card" style="width: 60%">
 <div class="card-body">
   <form method="POST" action="<?php echo base_url('ketua/agendaKhusus/tambahDataAksi') ?>">
	 ...
	 <a class="btn btn-danger" href="<?php echo base_url('ketua/agendaKhusus') ?>">Kembali</a>
   </form>
 </div>
</div>
