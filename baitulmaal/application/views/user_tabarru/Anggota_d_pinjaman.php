...
<!-- 					<li><a href="<?= base_url(""); ?>">Transaksi</a></li>
					...
					<li class="drop-down"><a href="#">Jabatan</a>
						<ul>
							...
							<li><a href="<?= base_url("anggotapinjaman/dashboard"); ?>">Anggota Divisi Pelayanan Pinjaman</a></li>
						</ul>
					</li>
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-6 order-1 order-lg-2 hero-img">
					<img src="<?= base_url('assets/photo/') . $this->session->userdata('foto') ?>" class="img-fluid animated rounded-circle" alt="" style="width: 480px; height: 480px;">
				</div>
			</div>
		</div>
		...
		<section id="about1" class="about">
			<div class="container">
				...
				<div class="col-lg-5 d-flex align-items-center justify-content-center about-img">
						<img src="<?php echo base_url() ?>assets/img/bm.png" class="img-fluid" alt="" data-aos="zoom-in">
					</div>
