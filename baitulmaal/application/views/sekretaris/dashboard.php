...
<section class="content ">
	...
	Selamat datang <?php echo $this->session->userdata('nama_anggota') ?> anda login sebagai <?php echo $this->session->userdata('jabatan') ?> Koperasi Tabarru.
	</div>
		...
		<div class="row">
            ...
            <div class="col-xl-2 col-md-6 mb-4">
              <div class="card border-left-danger shadow h-60 py-0">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-danger text-uppercase mb-1">Data Admin Tabarru</div>
            ...
            <div class="col-xl-2 col-md-6 mb-4">
              <div class="card border-left-primary shadow h-60 py-0">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-info text-uppercase mb-1">Data Agenda Khusus</div>
                      <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo $khusus ?></div>
                    </div>
                    <div class="col-auto">
