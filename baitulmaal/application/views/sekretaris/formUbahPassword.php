...
<div class="card-body">
	<form method="POST" action="<?php echo base_url('sekretaris/ubahPassword/ubahPasswordAksi') ?>">
	...
	<a class="btn btn-danger" href="<?php echo base_url('sekretaris/dashboard') ?>">Kembali</a>
	</form>
</div>
</div>
</center>
