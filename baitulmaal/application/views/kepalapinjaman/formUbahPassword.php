...
<div class="card-body">
	<form method="POST" action="<?php echo base_url('kepalapinjaman/ubahPassword/ubahPasswordAksi') ?>">
	...
	<a class="btn btn-danger" href="<?php echo base_url('kepalapinjaman/dashboard') ?>">Kembali</a>
	</form>
</div>
</div>
</center>
