...
<div class="card-body">
	<form method="POST" action="<?php echo base_url('anggotateller/ubahPassword/ubahPasswordAksi') ?>">
	...
	<a class="btn btn-danger" href="<?php echo base_url('anggotateller/dashboard') ?>">Kembali</a>
	</form>
</div>
</div>
</center>
