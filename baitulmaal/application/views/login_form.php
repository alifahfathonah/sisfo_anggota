              ...
              <div class="col-lg-12">
                <div class="p-5">
                  <div class="text-center">
                    <h1 class="h4 text-gray-900 mb-2">SISTEM MUAMALAH <br> <b>KOPERASI TABARRU</b></h1>
                    <div class="">
                  ...
                  <form class="user" method="POST" action="<?php base_url('login') ?>">
                    ...
                    <a class="btn btn-secondary btn-user btn-block" href="<?php echo base_url('welcome') ?>">Login Admin</a>
                  </form>
                  <br>
                  <div class="text-center">
